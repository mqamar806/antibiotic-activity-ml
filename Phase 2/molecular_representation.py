...
Validates SMILES strings with RDKit and converts each molecule to an ECFP4
(Morgan) fingerprint (radius = 2, 2048 bits). Outputs X_ecfp2048.npy
(feature matrix), y.npy (labels), and smiles_labels_valid.csv.
"""
